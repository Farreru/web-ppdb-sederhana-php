...
require_once('../layout/modals/sekolah.php');
?>

<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4 display-6 pb-1">List Sekolah</h1>
...
?>
            ...
            <script src="http://localhost/ppdb/admin/assets/js/sekolah.js">
            </script>
